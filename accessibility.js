...
lpTag.external.accessibilityFix = {
    ...
    engagementRenderedHandler: function (data) {      
        try {
            ...
            window.fetch("https://va.v.liveperson.net/api/account/23979466/monitoring/visitors/QzZWMwZmY5MjI4YjQzNjJk/visits/current/state?v=1&filter=agent&sid=zUbA0zY3R-Sx7pars-tTgA", {headers: "GET", "Accept": "application/json", "Content-Type": "application/json", "Authorization": `OAuth oauth_signature=""`} )
